...
def get_file_name():
    ...
    while city_name not in list(city_to_file.keys()):
        city_name = input('\nSorry, the name entered is not recognized. Please enter a valid city name from the three given options.\n'
...
def get_day():
    ...
    '''
    day = input('\nWhich day you want to filter the data for; monday, tuesday, wednesday, thursday, friday, saturday, or sunday?\n')
    day = day.strip().lower()
